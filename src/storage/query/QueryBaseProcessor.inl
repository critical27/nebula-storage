...
ErrorCode QueryBaseProcessor<REQ, RESP>::getSpaceEdgeSchema() {
    ...
    if (!edges.ok()) {
        return ErrorCode::E_STORAGE_SCHEMA_GET_ALL_EDGE_SCHEMA_FAILED;
    }
    ...
    switch (exp->kind()) {
        ...
        case Expression::Kind::kVar: {
            ...
            return varExp->isInner() ? ErrorCode::SUCCEEDED
                                     : ErrorCode::E_STORAGE_QUERY_INVALID_FILTER;
        }
        ...
        case Expression::Kind::kEdgeProperty: {
            ...
            */
            ...
            if (!inEdgeContext) {
                ...
                return ErrorCode::E_STORAGE_QUERY_INVALID_EXPRESSION;
            }
            if (updated) {
                valueProps_.emplace(propName);
            }
        ...
        case Expression::Kind::kVersionedVar: {
            ...
            return ErrorCode::E_STORAGE_QUERY_INVALID_FILTER;
        }
    }
    return ErrorCode::E_STORAGE_QUERY_INVALID_FILTER;
}
